...
SELECT 
    ...
    PUESTO_TRABAJO_TALLER.CAPACIDAD - (COUNT(PUESTO_TRABAJO_TALLER.IDTIPOTRABAJO)*TIPO_TRABAJO.DURACIONPROM) AS capacidad_disponible
FROM 
    TALLER
...
JOIN TIPO_TRABAJO ON PUESTO_TRABAJO_TALLER.IDTIPOTRABAJO = TIPO_TRABAJO.IDTIPOTRABAJO
